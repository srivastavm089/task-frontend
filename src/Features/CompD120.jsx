    ...
    <Fragment>
      {loader ? (
        ...
        <div className="relative bg-gray-500 h-full flex justify-center items-center flex-col flex-col-reverse gap-2      xl:flex-row">
          ...
          <div>
            <div className="flex p-12  w-screen  xl:flex-col gap-2 xl:w-[350px] xl:h-screen bg-gray-600  justify-center items-center  shadow-lg shadow-gray-600/50 ">
              <img
                className="xl:h-56 xl:w-56 border xl:rounded-full rounded-xl w-20 h-20 sm:h-36 sm:w-36"
                src={
                  image ||
              ...
              <div className="flex-col flex gap-2">
                <Button
                  component="label"
                  variant="contained"
                  className="h-1 sm:w-72 sm:h-12 w-36 h-12"
                  style={{fontSize:"10px", padding:"0", height:"5vh", }}
                >
                  Choose File
                  <VisuallyHiddenInput
                    type="file"
                ...
                <button
                  className="bg-[tomato]  rounded text-white sm:w-72 sm:h-8 w-36 h-12 text-sm  sm:text-lg"
                  style={{fontSize:"10px"}}
          ...
          <div className="flex center text-white xl:w-[80vw] flex-col gap-5 relative">
