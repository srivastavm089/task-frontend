    ...
    <Fragment>
      {loader ? (
        ...
        <div className=" relative bg-[#2A3137] xl:h-screen flex flex-col justify-center pt-10">
            ...
            <div className="flex gap-3 relative pt-1   overflow-scroll imagesSection ">
              {imageData.map((item) => {
                if (
                  ...
                  return (
                    <img
                      className="clippath h-36 w-36 sm:h-56 sm:w-56"
                      src={item.url}
                      alt={item.access}
                    />
                  );
          ...
          <div className="border border-2 h-[50vh]    flex gap-2  sm:gap-16  bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 justify-center items-center  shadow-lg shadow-gray-600/50 ">
            <img
              className="md:h-56  md:w-56 sm:w-36  w-20 h-20 sm:h-36 border rounded-full xl:w-20 xl:h-20"
              src={
                image ||
